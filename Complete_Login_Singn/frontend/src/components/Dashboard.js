        ...
        <div className="card-body text-center">
          {user && (
            <>
              ...
              <div>
                <button className="btn btn-success btn-block mt-3" onClick={handleAddProfile}>Add+</button>
                <button className="btn btn-success btn-block mt-3 mx-2" onClick={handleListProfile}>Total List</button>
              </div>
              <div>
                <button className="btn btn-danger btn-block mt-3 mx-2" onClick={handleLogout}>Logout  </button>
              
                <button className="btn btn-primary btn-block mt-3 mx-2" onClick={handleEditProfile}>Edit Profile </button>
